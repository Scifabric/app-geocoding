...
project = u'Geocoding demo application for PyBossa'
...
latex_documents = [
  ('index', 'GeoCoding.tex', u'Geocoding demo application for PyBossa Documentation',
...
man_pages = [
    ('index', 'app-geocoding', u'Geocoding demo application for PyBossa Documentation',
...
texinfo_documents = [
  ('index', 'geocoding', u'Geocoding demo application for PyBossa Documentation',
